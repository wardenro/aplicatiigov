	...
	function contentStiri(item, date){
		content = '<div class="container-stiri__item__container" data-role="collapsible"><h3>' + image(item.imagine) + 
			   	...
			   	'</div></h3><div class="container-stiri__item__container__content"><a href="#" onclick="cordova.InAppBrowser.open(\'http://gov.ro/ro/stiri/'+ 
			   	item.url + '\', \'_system\');">Vezi știre pe site</a><p>'+ 
